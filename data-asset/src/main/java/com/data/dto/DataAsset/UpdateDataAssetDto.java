 ...
 */
@Data
public class UpdateDataAssetDto {
    ...
    private List<UpdateDataAssetFieldDto> updateDataAssetFieldDtoLists;
    @ApiModelProperty("数据资产分类列表")
    private List<UpdateDataAssetRelationCategoryDto> updateDataAssetRelationCategoryDtoLists;
}
